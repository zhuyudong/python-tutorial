...
print(
    d.strftime("%Y-%m-%d %H:%M:%S %p %Z %z %j %U %W")
)  # 2024-09-09 22:28:12 PM UTC +0000 189 27 27
print(
    d.strftime("%Y-%m-%d %H:%M:%S %p %Z %z %j %U %W %w")
)  # 2024-09-09 22:28:12 PM UTC +0000 189 27 27 1
print(
    d.strftime("%Y-%m-%d %H:%M:%S %p %Z %z %j %U %W %w %a")
)  # 2024-09-09 22:28:12 PM UTC +0000 189 27 27 1 Tue
print(
    d.strftime("%Y-%m-%d %H:%M:%S %p %Z %z %j %U %W %w %a %A")
)  # 2024-09-09 22:28:12 PM UTC +0000 189 27 27 1 Tue Tuesday
print(
    d.strftime("%Y-%m-%d %H:%M:%S %p %Z %z %j %U %W %w %a %A %b")
)  # 2024-09-09 22:28:12 PM UTC +0000 189 27 27 1 Tue Tuesday Jul
print(
    d.strftime("%Y-%m-%d %H:%M:%S %p %Z %z %j %U %W %w %a %A %b %B")
)  # 2024-09-09 22:28:12 PM UTC +0000 189 27 27 1 Tue Tuesday Jul July
print(
    d.strftime("%Y-%m-%d %H:%M:%S %p %Z %z %j %U %W %w %a %A %b %B %c")
)  # 2024-09-09 22:28:12 PM UTC +0000 189 27 27 1 Tue Tuesday Jul July Tue Jul  7 15:00:00 2020
print(
    d.strftime("%Y-%m-%d %H:%M:%S %p %Z %z %j %U %W %w %a %A %b %B %c %x")
)  # 2024-09-09 22:28:12 PM UTC +0000 189 27 27 1 Tue Tuesday Jul July Tue Jul  7 15:00:00 2020
print(
    d.strftime("%Y-%m-%d %H:%M:%S %p %Z %z %j %U %W %w %a %A %b %B %c %x %X")
)  # 2024-09-09 22:28:12 PM UTC +0000 189 27 27 1 Tue Tuesday Jul July Tue Jul  7 15:00:00 2020 15:00:00
print(
    d.strftime("%Y-%m-%d %H:%M:%S %p %Z %z %j %U %W %w %a %A %b %B %c %x %X %f")
)  # 2024-09-09 22:28:12 PM UTC +0000 189 27 27 1 Tue Tuesday Jul July Tue Jul  7 15:00:00 2020 15:00:00 000000
print(
    d.strftime("%Y-%m-%d %H:%M:%S %p %Z %z %j %U %W %w %a %A %b %B %c %x %X %f %z")
)  # 2024-09-09 22:28:12 PM UTC +0000 189 27 27 1 Tue Tuesday Jul July Tue Jul  7 15:00:00 2020 15:00:00 000000 +0000
print(
...
print(
    time.localtime()
)  # time.struct_time(tm_year=2024, tm_mon=9, tm_mday=9, tm_hour=23, tm_min=0, tm_sec=29, tm_wday=0, tm_yday=253, tm_isdst=0)
